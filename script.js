...
let messageX = 190;
let messageY = 120;
let messageWidth = 195;
let messageHeight = 160;
...
function drawLifeLostMessage() {
    ctx.fillText("Lives left " + lives, canvas.width / 2 - 65, 150);
    ctx.fillText('Game continues in ', canvas.width / 2 - 90, 180)
...
function drawGameOverMessage() {
    ...
    ctx.fillText(gameStartTimer + ' seconds till start', canvas.width / 2 - 75, 150);
    ctx.font = "60px Courier New";
    ctx.fillText('Game ', canvas.width / 2 - 75, 200)
    ctx.fillText('over!  ', canvas.width / 2 - 85, 250)
}

function drawStartGameMessage() {
    ctx.fillStyle = "white";
    ctx.font = "100px Courier New";
    ctx.fillText(gameStartTimer, canvas.width / 2 - 30, canvas.height / 2 + 20)
}
...
function drawPlayerWinsMessage() {
    ...
    ctx.fillText('CONGRATULATIONS!', canvas.width / 2 - 85, 190);
    ctx.font = "15px Courier New";
    ctx.fillText('You destroyed all', canvas.width / 2 - 80, 220);
    ctx.fillText(' the bricks!', canvas.width / 2 - 75, 240);
...
function mouseMoveHandler(e) {
    ...
    // 50 and 530 is edges of the canvas
    if (relativeX > 50 && relativeX < 530) {
